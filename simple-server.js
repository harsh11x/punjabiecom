...
app.use(express.static('out')); // Serve static files if they exist
...
app.get('/', (req, res) => {
  res.send(`
    ...
    <html>
    <head>
      <title>Punjabi Heritage Store</title>
      <style>
    ...
    <body>
      <div class="container">
        <h1>🚀 Punjabi Heritage E-commerce Store</h1>
        <div class="status">
          <h2 class="success">✅ Server Running Successfully!</h2>
          <p><strong>Status:</strong> Ultra-Light Mode (512MB RAM)</p>
        ...
        <p><em>This is a lightweight server optimized for low-memory environments.</em></p>
      </div>
    </body>
    </html>
  `);
...
// Start server
app.listen(PORT, () => {
  console.log('🚀 Punjabi Heritage Store Server Started!');
  console.log(`📍 Port: ${PORT}`);
  console.log(`🌐 URL: http://localhost:${PORT}`);
  console.log(`🔧 Mode: Ultra-Light (512MB RAM)`);
  console.log(`💾 Storage: Local JSON files`);
  console.log('✅ Ready to serve your store!');
});
