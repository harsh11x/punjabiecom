...
export default function FulkariPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-pink-50 to-indigo-50">
      {/* Header */}
      <header className="border-b-4 border-purple-600 bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 text-white sticky top-0 z-50 shadow-lg">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="text-purple-100 hover:text-purple-300 hover:bg-purple-800/50"
              >
        ...
        <div className="h-2 bg-gradient-to-r from-purple-400 via-pink-500 to-indigo-500"></div>
      </header>
