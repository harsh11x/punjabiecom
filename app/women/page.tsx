...
export default function WomenPage() {
  ...
  // Fetch all women's products initially
  useEffect(() => {
    const fetchAllProducts = async () => {
      try {
        setLoading(true)
        const response = await fetch('/api/products?limit=1000&category=women')
        if (response.ok) {
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                  ...
                  <Link href="/women" className="block px-4 py-3 text-red-800 hover:bg-amber-50 bg-amber-100 font-bold">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <h1 className="text-4xl lg:text-7xl font-bold drop-shadow-lg">ਔਰਤਾਂ ਦਾ ਸੰਗ੍ਰਹਿ</h1>
              <div className="w-10 h-1 bg-gradient-to-r from-white to-amber-400 hidden md:block"></div>
            </div>
            <h2 className="text-2xl lg:text-4xl font-bold text-amber-200 mb-6">Women's Handmade Leather Jutti Collection</h2>
            <p className="text-lg opacity-90 max-w-4xl mx-auto leading-relaxed">
              ਔਰਤਾਂ ਲਈ ਵਿਸ਼ੇਸ਼ ਤੌਰ 'ਤੇ ਡਿਜ਼ਾਇਨ ਕੀਤੀ ਗਈ ਪਰੰਪਰਾਗਤ ਪੰਜਾਬੀ ਜੁੱਤੀ, ਸੁੰਦਰ ਕਢਾਈ ਅਤੇ ਸ਼ੁੱਧ ਚਮੜੇ ਨਾਲ।
              <br />
              <span className="italic text-amber-200">
                Discover our exquisite collection of women's traditional Punjabi jutti, handcrafted with pure leather
                and adorned with beautiful embroidery for the elegant woman who cherishes heritage.
              </span>
            </p>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
                ...
                <div className="text-center py-8 mt-8">
                  <div className="bg-gradient-to-r from-green-100 to-emerald-100 border-2 border-green-300 rounded-2xl p-6 max-w-2xl mx-auto">
                    <h3 className="text-xl font-bold text-green-800 mb-2">
                      🎉 All Women's Products Loaded!
                    </h3>
                    <p className="text-gray-700">
                      You've reached the end of our women's collection. All {displayedProducts.length} products are now displayed.
                    </p>
                  </div>
                </div>
              )}
          ...
          <div className="mt-8 p-4 bg-gray-100 rounded-lg border border-gray-300">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">🔍 Women's Products Debug Info</h3>
