    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-red-50">
      ...
      <section className="py-12 lg:py-20 bg-gradient-to-b from-red-50 via-orange-50 to-amber-50 relative">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          {/* Simple featured products placeholder - no complex client components */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-8">
            <div className="bg-white/80 rounded-lg border border-amber-200 p-6 text-center shadow-lg">
              <div className="h-48 bg-gradient-to-r from-amber-100 to-red-100 rounded-lg mb-4 flex items-center justify-center">
                <p className="text-red-800 font-semibold">Featured Products Loading...</p>
              </div>
              <p className="text-gray-600">Browse our full collection in the products page</p>
            </div>
          </div>
        </div>
      </section>
