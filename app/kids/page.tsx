...
export default function KidsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-yellow-50 to-green-50">
      {/* Header */}
      <header className="border-b-4 border-orange-600 bg-gradient-to-r from-green-900 via-orange-900 to-yellow-800 text-white sticky top-0 z-50 shadow-lg">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <Baby className="h-8 w-8 text-orange-300" />
              <div>
                <h1 className="text-2xl font-bold text-orange-100">Kids Collection</h1>
                <p className="text-orange-200">ਬੱਚਿਆਂ ਦਾ ਸੰਗ੍ਰਹਿ • Adorable Punjabi wear for kids</p>
              </div>
            </div>
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="text-orange-100 hover:text-orange-300 hover:bg-orange-800/50"
              >
